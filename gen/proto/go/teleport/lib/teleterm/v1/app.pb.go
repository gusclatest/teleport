...
var file_teleport_lib_teleterm_v1_app_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
...
var file_teleport_lib_teleterm_v1_app_proto_depIdxs = []int32{
	3, // 0: teleport.lib.teleterm.v1.App.labels:type_name -> teleport.lib.teleterm.v1.Label
