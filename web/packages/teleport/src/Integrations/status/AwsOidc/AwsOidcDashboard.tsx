...
export function AwsOidcDashboard() {
  ...
  return (
    <FeatureBox css={{ maxWidth: '1400px', paddingTop: '16px' }}>
      ...
      <Flex gap={3}>
        {awsec2 && <StatCard resource={AwsResource.ec2} summary={awsec2} />}
        {awsrds && <StatCard resource={AwsResource.rds} summary={awsrds} />}
        {awseks && <StatCard resource={AwsResource.eks} summary={awseks} />}
      </Flex>
    </FeatureBox>
  );
}
